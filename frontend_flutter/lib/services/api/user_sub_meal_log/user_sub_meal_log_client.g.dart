...
class _UserSubMealLogClient implements UserSubMealLogClient {
  _UserSubMealLogClient(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<UserSubMealLogEntity>> userSubMealLogControllerGetByMainMealId({
    ...
    final _options = _setStreamType<List<UserSubMealLogEntity>>(
    ...
    late List<UserSubMealLogEntity> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
  ...
  Future<GetManyUserSubMealLogEntityResponseDto>
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetManyUserSubMealLogEntityResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/rest/UserSubMealLog',
    ...
    late GetManyUserSubMealLogEntityResponseDto _value;
    try {
      _value = GetManyUserSubMealLogEntityResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<UserSubMealLogEntity>
    ...
    final _options = _setStreamType<UserSubMealLogEntity>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UserSubMealLogEntity _value;
    try {
      _value = UserSubMealLogEntity.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
