...
class UserApi {
  ...
  Future<Response<BuiltList<JsonObject>>> createManyBaseUserControllerUserEntity({ 
    required CreateManyUserEntityDto createManyUserEntityDto,
    ...
    try {
      const _type = FullType(CreateManyUserEntityDto);
      _bodyData = _serializers.serialize(createManyUserEntityDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> createOneBaseUserControllerUserEntity({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteOneBaseUserControllerUserEntity({ 
    required num id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/rest/User/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetManyUserEntityResponseDto>> getManyBaseUserControllerUserEntity({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetManyUserEntityResponseDto),
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getOneBaseUserControllerUserEntity({ 
    required num id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> replaceOneBaseUserControllerUserEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> updateOneBaseUserControllerUserEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> userController({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rest/User/metadata';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
