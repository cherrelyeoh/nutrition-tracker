...
class AIPromptApi {
  ...
  const AIPromptApi(this._dio, this._serializers);
  ...
  Future<Response<void>> aIPromptController({ 
    ...
    final _path = r'/rest/AIPrompt/metadata';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> aIPromptControllerTestFunction({ 
    required AIPromptControllerTestFunctionRequest aIPromptControllerTestFunctionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rest/AIPrompt/testFunction';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(AIPromptControllerTestFunctionRequest);
      _bodyData = _serializers.serialize(aIPromptControllerTestFunctionRequest, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<JsonObject>>> createManyBaseAIPromptControllerAIPromptEntity({ 
    required CreateManyAIPromptEntityDto createManyAIPromptEntityDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rest/AIPrompt/bulk';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateManyAIPromptEntityDto);
      _bodyData = _serializers.serialize(createManyAIPromptEntityDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> createOneBaseAIPromptControllerAIPromptEntity({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteOneBaseAIPromptControllerAIPromptEntity({ 
    required num id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/rest/AIPrompt/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyAIPromptEntityResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetManyAIPromptEntityResponseDto>> getManyBaseAIPromptControllerAIPromptEntity({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (fields != null) r'fields': encodeCollectionQueryParameter<String>(_serializers, fields, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
    ...
    GetManyAIPromptEntityResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetManyAIPromptEntityResponseDto),
      ) as GetManyAIPromptEntityResponseDto;
    ...
    return Response<GetManyAIPromptEntityResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getOneBaseAIPromptControllerAIPromptEntity({ 
    required num id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> replaceOneBaseAIPromptControllerAIPromptEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> updateOneBaseAIPromptControllerAIPromptEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
