...
class UserMealLogApi {

  final Dio _dio;

  final Serializers _serializers;

  const UserMealLogApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<JsonObject>>> createManyBaseUserMealLogControllerUserMealLogEntity({ 
    required CreateManyUserMealLogEntityDto createManyUserMealLogEntityDto,
    ...
    final _path = r'/rest/UserMealLog/bulk';
    ...
    try {
      const _type = FullType(CreateManyUserMealLogEntityDto);
      _bodyData = _serializers.serialize(createManyUserMealLogEntityDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> createOneBaseUserMealLogControllerUserMealLogEntity({ 
    ...
    final _path = r'/rest/UserMealLog';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteOneBaseUserMealLogControllerUserMealLogEntity({ 
    required num id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/rest/UserMealLog/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyUserMealLogEntityResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetManyUserMealLogEntityResponseDto>> getManyBaseUserMealLogControllerUserMealLogEntity({ 
    ...
    GetManyUserMealLogEntityResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetManyUserMealLogEntityResponseDto),
      ) as GetManyUserMealLogEntityResponseDto;
    ...
    return Response<GetManyUserMealLogEntityResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getOneBaseUserMealLogControllerUserMealLogEntity({ 
    required num id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> replaceOneBaseUserMealLogControllerUserMealLogEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> updateOneBaseUserMealLogControllerUserMealLogEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> userMealLogController({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rest/UserMealLog/metadata';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserMealLogControllerExtractNutrientDetails200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserMealLogControllerExtractNutrientDetails200Response>> userMealLogControllerExtractNutrientDetails({ 
    required UserMealLogControllerExtractNutrientDetailsRequest userMealLogControllerExtractNutrientDetailsRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rest/UserMealLog/extractNutrientDetails';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UserMealLogControllerExtractNutrientDetailsRequest);
      _bodyData = _serializers.serialize(userMealLogControllerExtractNutrientDetailsRequest, specifiedType: _type);
    ...
    UserMealLogControllerExtractNutrientDetails200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(UserMealLogControllerExtractNutrientDetails200Response),
      ) as UserMealLogControllerExtractNutrientDetails200Response;
    ...
    return Response<UserMealLogControllerExtractNutrientDetails200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
