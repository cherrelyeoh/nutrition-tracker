...
class UserMealQuestionsApi {

  final Dio _dio;

  final Serializers _serializers;

  const UserMealQuestionsApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<JsonObject>>> createManyBaseUserMealQuestionsControllerUserMealQuestionsEntity({ 
    required CreateManyUserMealQuestionsEntityDto createManyUserMealQuestionsEntityDto,
    ...
    final _path = r'/rest/UserMealQuestions/bulk';
    ...
    try {
      const _type = FullType(CreateManyUserMealQuestionsEntityDto);
      _bodyData = _serializers.serialize(createManyUserMealQuestionsEntityDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> createOneBaseUserMealQuestionsControllerUserMealQuestionsEntity({ 
    ...
    final _path = r'/rest/UserMealQuestions';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteOneBaseUserMealQuestionsControllerUserMealQuestionsEntity({ 
    required num id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/rest/UserMealQuestions/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyUserMealQuestionsEntityResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetManyUserMealQuestionsEntityResponseDto>> getManyBaseUserMealQuestionsControllerUserMealQuestionsEntity({ 
    ...
    GetManyUserMealQuestionsEntityResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetManyUserMealQuestionsEntityResponseDto),
      ) as GetManyUserMealQuestionsEntityResponseDto;
    ...
    return Response<GetManyUserMealQuestionsEntityResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getOneBaseUserMealQuestionsControllerUserMealQuestionsEntity({ 
    required num id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> replaceOneBaseUserMealQuestionsControllerUserMealQuestionsEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> updateOneBaseUserMealQuestionsControllerUserMealQuestionsEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> userMealQuestionsController({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rest/UserMealQuestions/metadata';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
