...
class AIIntegrationLogsApi {

  final Dio _dio;

  final Serializers _serializers;

  const AIIntegrationLogsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> aIIntegrationLogsController({ 
    ...
    final _path = r'/rest/AIIntegrationLogs/metadata';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<JsonObject>>> createManyBaseAIIntegrationLogsControllerAIIntegrationLogsEntity({ 
    required CreateManyAIIntegrationLogsEntityDto createManyAIIntegrationLogsEntityDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/rest/AIIntegrationLogs/bulk';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateManyAIIntegrationLogsEntityDto);
      _bodyData = _serializers.serialize(createManyAIIntegrationLogsEntityDto, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> createOneBaseAIIntegrationLogsControllerAIIntegrationLogsEntity({ 
    ...
    final _path = r'/rest/AIIntegrationLogs';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteOneBaseAIIntegrationLogsControllerAIIntegrationLogsEntity({ 
    required num id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/rest/AIIntegrationLogs/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetManyAIIntegrationLogsEntityResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetManyAIIntegrationLogsEntityResponseDto>> getManyBaseAIIntegrationLogsControllerAIIntegrationLogsEntity({ 
    ...
    GetManyAIIntegrationLogsEntityResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GetManyAIIntegrationLogsEntityResponseDto),
      ) as GetManyAIIntegrationLogsEntityResponseDto;
    ...
    return Response<GetManyAIIntegrationLogsEntityResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> getOneBaseAIIntegrationLogsControllerAIIntegrationLogsEntity({ 
    required num id,
    BuiltList<String>? fields,
    BuiltList<String>? join,
    int? cache,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> replaceOneBaseAIIntegrationLogsControllerAIIntegrationLogsEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [JsonObject] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JsonObject>> updateOneBaseAIIntegrationLogsControllerAIIntegrationLogsEntity({ 
    required num id,
    required JsonObject body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
