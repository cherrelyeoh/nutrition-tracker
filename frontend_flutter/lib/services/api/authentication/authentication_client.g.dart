...
class _AuthenticationClient implements AuthenticationClient {
  ...
  @override
  Future<UserEntity> userControllerSignUp({required SignUpDto body}) async {
  ...
  @override
  Future<LoginResponseDto> userControllerLogin({required LoginDto body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<GetManyUserEntityResponseDto> getManyBaseUserControllerUserEntity({
    ...
    final _options = _setStreamType<GetManyUserEntityResponseDto>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetManyUserEntityResponseDto _value;
    try {
      _value = GetManyUserEntityResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<UserEntity>> createManyBaseUserControllerUserEntity({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<List<UserEntity>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/rest/User/bulk',
    ...
    try {
      _value = _result.data!
          .map(
            (dynamic i) => UserEntity.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<void> deleteOneBaseUserControllerUserEntity({required num id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
